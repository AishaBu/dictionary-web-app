...
/*API CALL*/
/*Dictionary Api Call*/
function fetchVocabularyWordsDefault(_x) {
  return _fetchVocabularyWordsDefault.apply(this, arguments);
}
/*Thesaurus Api Call*/
function _fetchVocabularyWordsDefault() {
  _fetchVocabularyWordsDefault = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(searchFieldValue) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          ...
          console.error("Could not get word: ".concat(_global_variables__WEBPACK_IMPORTED_MODULE_1__.searchField.value));
...
function displaySynonymsDefault() {
  var promise = fetchSynonymsThesaurusDefault(defaultWord);
