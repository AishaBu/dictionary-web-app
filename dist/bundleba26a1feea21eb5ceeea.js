...
var apiKey = "585651c1-6ea4-4761-b3e7-d7af4eea540e";
/*API CALL*/
...
function displayWords() {
  ...
  promise.then(function (data) {
    return _global_variables__WEBPACK_IMPORTED_MODULE_0__.vocabWord.textContent = data[1].hwi.hw;
  });
...
function checkRegexMatch() {
  ...
  _global_variables__WEBPACK_IMPORTED_MODULE_3__.searchField.addEventListener("input", function () {
    _global_variables__WEBPACK_IMPORTED_MODULE_3__.searchField.addEventListener("keydown", function (event) {
      if (!_global_variables__WEBPACK_IMPORTED_MODULE_3__.searchField.value.match(regex) && event.key == "Enter") {
...
function checkFormOnSubmit() {
  _global_variables__WEBPACK_IMPORTED_MODULE_3__.form.addEventListener("submit", function (event) {
    if (_global_variables__WEBPACK_IMPORTED_MODULE_3__.searchField.validity.valueMissing) {
      ...
      event.stopPropagation(); //stops further propogation in event/bubbling phases
      _global_variables__WEBPACK_IMPORTED_MODULE_3__.searchField.setAttribute("id", "invalid-search-field");
      _global_variables__WEBPACK_IMPORTED_MODULE_3__.errorSearchMessage.textContent = "Please type a word before sending!";
      _global_variables__WEBPACK_IMPORTED_MODULE_3__.errorSearchMessage.setAttribute("id", "invalid-error-message");
    }
  });
}
...
/******/ })()
;
//# sourceMappingURL=bundleba26a1feea21eb5ceeea.js.map