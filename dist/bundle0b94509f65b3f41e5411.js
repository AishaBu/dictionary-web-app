    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("https://www.dictionaryapi.com/api/v3/references/collegiate/json/voluminous?key=585651c1-6ea4-4761-b3e7-d7af4eea540e");
        case 3:
...
_global_variables__WEBPACK_IMPORTED_MODULE_3__.form.addEventListener('submit', function (event) {
  ...
  var promise = fetchVocabularyWords();
  promise.then(function (data) {
    return _global_variables__WEBPACK_IMPORTED_MODULE_3__.vocabWord.textContent = data[0].word;
  });
...
/******/ })()
;
//# sourceMappingURL=bundle0b94509f65b3f41e5411.js.map