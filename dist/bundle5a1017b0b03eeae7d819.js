    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("https://api.dictionaryapi.dev/api/v2/entries/en/".concat(searchFieldValue));
        case 3:
...
_global_variables__WEBPACK_IMPORTED_MODULE_0__.form.addEventListener('submit', function (event) {
  ...
  promise.then(function (data) {
    return _global_variables__WEBPACK_IMPORTED_MODULE_0__.vocabWord.textContent = data[0].word;
  });
});
...
/******/ })()
;
//# sourceMappingURL=bundle5a1017b0b03eeae7d819.js.map