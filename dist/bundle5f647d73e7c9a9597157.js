...
function displayWords() {
  ...
  promise.then(function (data) {
    return _global_variables__WEBPACK_IMPORTED_MODULE_0__.vocabWord.textContent = data[0].meta.id;
  });
